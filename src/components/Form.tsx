...
export const Form:React.FC = () => {
  ...
  const [formData, setformData] = useState(intialConatct)
  ...
  useEffect(() => {
    if (id) {
      const currentContact:any = contact.getId(id)
  ...
  return (
    <form className="form " id="form" onSubmit={handleSubmit} >
      ...
      <div className="buttonbox">
        ...
        <input type="submit" disabled={!!(errors.name||errors.email||errors.mobile||errors.landline||errors.website||errors.address)} name="Add" id="Add" value="Add" ></input>
      </div>
    </form>
